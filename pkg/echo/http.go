...
func MakeHTTPHandler(ctx context.Context, s Service) http.Handler {
	...
	r.Methods("GET").Path("/echo").Handler(httptransport.NewServer(
		makeGetEchoEndpoint(s),
		decodeGETGetEchoListRequest,
		encodeResponse,
		options...,
	))
...
func decodeGETGetEchoListRequest(_ context.Context, r *http.Request) (interface{}, error) {
